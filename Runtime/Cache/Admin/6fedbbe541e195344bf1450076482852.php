...
<body>
<div class="header">
<h2 class="z cl"><a href="<?php echo U('index/index');?>"><img src="/Public/img/logo.png"></a></h2>
<div class="y cl">
...
<ul class="cl">
<li><i class="layui-icon">&#xe63a;</i><a target="_blank" href="https://www.templet360.com/forum.html">社区问答</a></li>
</ul>
</div>
<div class="aright">
<div class="aright_1">
<blockquote style="padding: 10px;border-left: 5px solid #FF5722;" class="layui-elem-quote">欢迎试用Templet360内容管理系统，先温馨提醒几个常见问题：</blockquote>
<table width="100%">
<tr>
<td width="480px">程序正式上线运营请把index.php里面调试模式关闭；<a href="https://www.templet360.com/thread-2.html" style="color:#FF5722;" target="_blank">查看教程</a></td>
<td>确认服务器或空间开启了伪静态；<a href="https://www.templet360.com/thread-3.html" style="color:#FF5722;" target="_blank">查看教程</a></td>
</tr>
<tr>
<td>安装完成后请将根目录install文件和index.php里面安装代码删除；<a href="https://www.templet360.com/thread-1.html" style="color:#FF5722;" target="_blank">查看教程</a></td>
...
<table width="100%">
<tr><td width="110px">程序版本</td><td>Tpt-blog 1.1 博客管理系统 <a href="https://www.templet360.com/" style="color:#FF5722;" target="_blank">查看最新版本</a></td></tr>
...
<table width="100%">
<tr><td width="110px">版权所有</td><td>成都极酷科技有限公司</td></tr>
