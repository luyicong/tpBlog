...
<form class="layui-form bform" method="post" action="<?php echo U('article/doedit');?>" enctype="multipart/form-data">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">缩略图</label>
     ...
     <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($a[pic] != ''): ?><img src="/Uploads<?php echo ($a["pic"]); ?>" height="50"><?php else: endif; ?>
